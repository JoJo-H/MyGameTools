...
type BigType = string|number|Big;

declare class Big {
    constructor(value:BigType);
    c:number[];
    e:number;
    s:number;
    eq(val:BigType):boolean;
    gt(val:BigType):boolean;
    gte(val:BigType):boolean;
    lt(val:BigType):boolean;
    lte(val:BigType):boolean;
    times(val:BigType):Big;
    sub(val:BigType):Big;
    plus(val:BigType):Big;
    div(val:BigType):Big;
}
