    ...
    return (function e(t, n, r) { function s(o, u) { if (!n[o]) {
        ...
        s(r[o]); return s; })({ 1: [function (_dereq_, module, exports) {
                ...
                Grid.prototype._buildNodes = function (width, height, matrix) {
                    var i, j, nodes = new Array(height), row;
                    for (i = 0; i < height; ++i) {
                ...
                Grid.prototype.clone = function () {
                    var i, j, width = this.width, height = this.height, thisNodes = this.nodes, newGrid = new Grid(width, height), newNodes = new Array(height), row;
                    for (i = 0; i < height; ++i) {
                ...
                function smoothenPath(grid, path) {
                    ...
                    newPath, i, j, coord, line, testCoord, blocked,lastValidCoord;
                    sx = x0;
                    sy = y0;
                    newPath = [[sx, sy]];
                    for (i = 2; i < len; ++i) {
            ...
            }, { "../core/DiagonalMovement": 3, "../core/Heuristic": 5, "../core/Util": 7, "heap": 1 }] }, {}, [8])(8);
});
var PF;
(function (PF) {
